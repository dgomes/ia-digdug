...
mapa13x13 =  [[Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE,Tiles.STONE], 
            [Tiles.STONE,Tiles.PASSAGE,Tiles.STONE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.PASSAGE,Tiles.STONE], 
...
def test_map():
    ...
    game.map = Map(enemies=0, size=(13,13), mapa=mapa13x13, enemies_spawn=[(8,8), (7,8), (8,7)], rocks=[(1,11)]) 
